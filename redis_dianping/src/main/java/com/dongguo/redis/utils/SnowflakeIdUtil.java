...
import com.dongguo.redis.support.ApplicationContextHolder;
...
import static com.dongguo.redis.utils.RedisConstants.CACHE_SNOWFLAKE_WORKID_key;
...
public class SnowflakeIdUtil {
    private static final Snowflake SNOWFLAKE = IdUtil.getSnowflake(getWorkerId(CACHE_SNOWFLAKE_WORKID_key), 1);
