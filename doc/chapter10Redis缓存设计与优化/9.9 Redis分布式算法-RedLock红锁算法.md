...
![image-20240314220643952](F:\note\image\image-20240314220643952.png)

8082

![image-20240314220632952](F:\note\image\image-20240314220632952.png)

这里有个问题，redLock.tryLock()还是不会续期，超过过期时间锁就删除了，即使你业务还没有结束。所以一定要保证过期时间远大于业务执行时间
