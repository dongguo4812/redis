...
注意mapper-location不要写成config-location
...
注意导包import tk.mybatis.spring.annotation.MapperScan;
...
public class UserController {
    ...
    @PostMapping("/addUser")
    public void addUser(@RequestBody UserDTO userBO) {
        User user = new User();
    ...
    public void editUser(@RequestBody UserDTO userBO) {
        User user = new User();
        BeanUtils.copyProperties(userBO, user);
