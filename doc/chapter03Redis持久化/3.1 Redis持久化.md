...
- ~~Redis服务端正常退出时（systemctl stop redis）   存疑~~
- 主从复制时。主节点会主动触发
...
```shell
D:\software\redis-6.2.6-win>redis-cli -a root
Warning: Using a password with '-a' or '-u' option on the command line interface may not be safe.
...
先对dump6379.rdb文件进行备份

```
cp dump6379.rdb dump6379.rdb.bak
```

然后随意修改dump6379.rdb文件中的内容
...
```shell
D:\software\redis-6.2.6-win>redis-check-rdb dump.rdb
[offset 0] Checking RDB file dump.rdb
[offset 26] AUX FIELD redis-ver = '6.2.6'
[offset 40] AUX FIELD redis-bits = '64'
[offset 52] AUX FIELD ctime = '1709517949'
[offset 67] AUX FIELD used-mem = '523923'
[offset 83] AUX FIELD aof-preamble = '0'
[offset 85] Selecting DB ID 0
--- RDB ERROR DETECTED ---
[offset 103] Unexpected EOF reading RDB file
...
默认情况下，redis的AOF功能没有开启，开启AOF功能需要设置: appendonly yes
